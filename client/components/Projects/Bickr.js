...
export default class Bickr extends React.Component {
      ...
      <div className="page page-container animated fadeIn">
        <Col md={6} sm={8} xs={12}>
          ...
          <div className="project-body">
            <p id="bickr-collaborators"><span className="bold">Collaborators: </span>Abe Johnson, Max Legocki, Shayan Sheikh</p>
